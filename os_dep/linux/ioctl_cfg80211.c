	...
	u8 ht, bool started)
{
	...
	if (started) {
		...
		cfg80211_ch_switch_started_notify(adapter->pnetdev, 0, &chdef, 0, false, false);
#elif (LINUX_VERSION_CODE >= KERNEL_VERSION(5, 15, 0))
		cfg80211_ch_switch_started_notify(adapter->pnetdev, &chdef, 0, false, false);
...
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(5, 19, 0))
    	cfg80211_ch_switch_notify(adapter->pnetdev, 0, &chdef, false);
#else
